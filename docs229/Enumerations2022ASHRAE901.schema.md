# ClimateZoneOptions2022ASHRAE901
...
# CompliancePathOptions2022ASHRAE901
|    Enumerator    |   Description   | Notes |
| ---------------- | --------------- | ----- |
| `CODE_COMPLIANT` | Code Compliance |       |
| `BEYOND_CODE`    | Beyond Code     |       |

# ConstructionClassificationOptions2022ASHRAE901
|   Enumerator   | Description  | Notes |
| -------------- | ------------ | ----- |
| `STEEL_FRAMED` | Steel-framed |       |

# EnvelopeSpaceOptions2022ASHRAE901
|          Enumerator          |        Description         | Notes |
| ---------------------------- | -------------------------- | ----- |
...
# ExteriorLightingAreaOptions2022ASHRAE901TableG36
|              Enumerator              |                Description                |                                                                                        Notes                                                                                         |
| ------------------------------------ | ----------------------------------------- | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------ |
...
# ExteriorLightingZoneOptions2022ASHRAE901
|            Enumerator             |            Description            |                                                                               Notes                                                                                |
| --------------------------------- | --------------------------------- | ------------------------------------------------------------------------------------------------------------------------------------------------------------------ |
...
# HeatingVentilatingAirConditioningBuildingAreaOptions2022ASHRAE901
|       Enumerator        |      Description      | Notes |
| ----------------------- | --------------------- | ----- |
...
# LightingBuildingAreaOptions2022ASHRAE901T951TG38
|          Enumerator          |         Description         |                                             Notes                                              |
| ---------------------------- | --------------------------- | ---------------------------------------------------------------------------------------------- |
...
# LightingPurposeOptions2022ASHRAE901
|    Enumerator    |  Description   | Notes |
| ---------------- | -------------- | ----- |
| `GENERAL`        | General        |       |
| `TASK`           | Task           |       |
...
# LightingSpaceOptions2022ASHRAE901TG37
|                        Enumerator                         |                                Description                                 |                                    Notes                                    |
| --------------------------------------------------------- | -------------------------------------------------------------------------- | --------------------------------------------------------------------------- |
...
| `LABORATORY_SCHOOL`                                       | Laboratory - Preschool through 12th grade, laboratory, and shop classrooms |                                                                             |
...
| `SECURITY_SCREENING_TRANSPORTATION_SCREENING`             | Airport/bus/ship/train/transportation screening                            |                                                                             |
...
| `CASINO_BETTING_AREA`                                     | Casino - Betting/sportsbook/keno/bingo area                                |                                                                             |
...
| `CORRECTIONAL_FACILITY_AUDIENCE_SEATING_AREA`             | Correctional Facility â€” Audience Seating Area                            |                                                                             |
| `CORRECTIONAL_FACILITY_CLASSROOM`                         | Correctional Facility â€” Classroom                                        |                                                                             |
| `CORRECTIONAL_FACILITY_CONFINEMENT_CELLS`                 | Correctional Facility â€” Confinement Cells                                |                                                                             |
| `CORRECTIONAL_FACILITY_DINING_AREA`                       | Correctional Facility â€” Dining Area                                      |                                                                             |
| `DORMITORY_LIVING_QUARTERS`                               | Dormitory â€” Living Quarters                                              |                                                                             |
| `FACILITY_FOR_VISUALLY_IMPAIRED_CHAPEL`                   | Facility for the Visually Impaired â€” Chapel                              |                                                                             |
| `FACILITY_FOR_VISUALLY_IMPAIRED_CORRIDOR`                 | Facility for the Visually Impaired â€” Corridor                            |                                                                             |
| `FACILITY_FOR_VISUALLY_IMPAIRED_DINING`                   | Facility for the Visually Impaired â€” Dining                              |                                                                             |
| `FACILITY_FOR_VISUALLY_IMPAIRED_LOBBY`                    | Facility for the Visually Impaired â€” Lobby                               |                                                                             |
| `FACILITY_FOR_VISUALLY_IMPAIRED_RECREATION_ROOM`          | Facility for the Visually Impaired â€” Recreation Room                     |                                                                             |
| `FACILITY_FOR_VISUALLY_IMPAIRED_RESTROOM`                 | Facility for the Visually Impaired â€” Restroom                            |                                                                             |
...
| `HEALTHCARE_FACILITY_CONTROL_ROOM`                        | Healthcare Facility - Control room                                         |                                                                             |
| `HEALTHCARE_FACILITY_EXAM_TREATMENT_ROOM`                 | Healthcare Facility - Exam/treatment room                                  |                                                                             |
| `HEALTHCARE_FACILITY_HOSPITAL_CORRIDOR`                   | Healthcare Facility - Hospital corridor                                    |                                                                             |
...
| `HEALTHCARE_FACILITY_TELEMEDICINE`                        | Healthcare Facility - Telemedicine                                         |                                                                             |
...
| `RELIGIOUS_FACILITY_AUDIENCE_SEATING_AREA`                | Religious Facility - Audience seating area                                 |                                                                             |
...
| `RETAIL_FACILITIES_HAIR_CARE`                             | Retail Facilities - Hair care                                              |                                                                             |
| `RETAIL_FACILITIES_MANICURE_PEDICURE`                     | Retail Facilities - Manicure/pedicure                                      |                                                                             |
| `RETAIL_FACILITIES_MALL_CONCOURSE`                        | Retail Facilities - Mall concourse                                         |                                                                             |
| `RETAIL_FACILITIES_MASSAGE`                               | Retail Facilities - Massage                                                |                                                                             |
...
| `NATATORIUM_CLASS_I_FACILITY`                             | Natatorium - Class I facility                                              |                                                                             |
| `NATATORIUM_CLASS_II_FACILITY`                            | Natatorium - Class II facility                                             |                                                                             |
| `NATATORIUM_CLASS_III_FACILITY`                           | Natatorium - Class III facility                                            |                                                                             |
| `NATATORIUM_CLASS_IV_FACILITY`                            | Natatorium - Class IV facility                                             |                                                                             |
| `TRANSPORTATION_FACILITY_AIRPORT_HANGER`                  | Transportation Facility - Airport hanger                                   |                                                                             |
...
| `TRANSPORTATION_FACILITY_PASSENGER_LOADING_AREA`          | Transportation Facility - Passenger loading area                           |                                                                             |
...
| `NONE`                                                    | None                                                                       | Indicates that the space will have no occupancy, such as an elevator shaft. |

# OutputSchemaOptions2022ASHRAE901
|           Enumerator           |            Description             | Notes |
| ------------------------------ | ---------------------------------- | ----- |
| `OUTPUT_SCHEMA_ASHRAE901_2022` | Output schema for ASHRAE 90.1 2022 |       |

# PrescribedScheduleOptions2022ASHRAE901
|    Enumerator    |                                                     Description                                                     | Notes |
| ---------------- | ------------------------------------------------------------------------------------------------------------------- | ----- |
| `NOT_APPLICABLE` | No prescribed schedules for Appendix G of ASHRAE Standard 90.1-2022. This field may be relavent for other rulesets. |       |

# RulesetModelOptions2022ASHRAE901
|   Enumerator   |                                                             Description                                                              | Notes |
| -------------- | ------------------------------------------------------------------------------------------------------------------------------------ | ----- |
...
# ServiceWaterHeatingAreaOptions2022ASHRAE901
|            Enumerator             |              Description               | Notes |
| --------------------------------- | -------------------------------------- | ----- |
| `AUTOMOTIVE_FACILITY`             | Automotive facility                    |       |
...
# SubsurfaceFrameOptions2022ASHRAE901
|        Enumerator        |          Description           | Notes |
| ------------------------ | ------------------------------ | ----- |
...
# SubsurfaceSubclassificationOptions2022ASHRAE901
|       Enumerator        |                                                                                        Description                                                                                        | Notes |
| ----------------------- | ----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | ----- |
...
# VentilationSpaceOptions2022ASHRAE901
|                                                        Enumerator                                                        |                                                        Description                                                         | Notes |
| ------------------------------------------------------------------------------------------------------------------------ | -------------------------------------------------------------------------------------------------------------------------- | ----- |
...
# VerticalFenestrationBuildingAreaOptions2022ASHRAE901
|            Enumerator             |            Description            | Notes |
| --------------------------------- | --------------------------------- | ----- |
| `GROCERY_STORE`                   | Grocery store                     |       |
