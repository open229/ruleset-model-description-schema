...
| `CORRECTIONAL_FACILITY_AUDIENCE_SEATING_AREA`             | Correctional Facility - Audience Seating Area                              |                                                                             |
| `CORRECTIONAL_FACILITY_CLASSROOM`                         | Correctional Facility - Classroom                                          |                                                                             |
| `CORRECTIONAL_FACILITY_CONFINEMENT_CELLS`                 | Correctional Facility - Confinement Cells                                  |                                                                             |
| `CORRECTIONAL_FACILITY_DINING_AREA`                       | Correctional Facility - Dining Area                                        |                                                                             |
| `DORMITORY_LIVING_QUARTERS`                               | Dormitory - Living Quarters                                                |                                                                             |
| `FACILITY_FOR_VISUALLY_IMPAIRED_CHAPEL`                   | Facility for the Visually Impaired - Chapel                                |                                                                             |
| `FACILITY_FOR_VISUALLY_IMPAIRED_CORRIDOR`                 | Facility for the Visually Impaired - Corridor                              |                                                                             |
| `FACILITY_FOR_VISUALLY_IMPAIRED_DINING`                   | Facility for the Visually Impaired - Dining                                |                                                                             |
| `FACILITY_FOR_VISUALLY_IMPAIRED_LOBBY`                    | Facility for the Visually Impaired - Lobby                                 |                                                                             |
| `FACILITY_FOR_VISUALLY_IMPAIRED_RECREATION_ROOM`          | Facility for the Visually Impaired - Recreation Room                       |                                                                             |
| `FACILITY_FOR_VISUALLY_IMPAIRED_RESTROOM`                 | Facility for the Visually Impaired - Restroom                              |                                                                             |
