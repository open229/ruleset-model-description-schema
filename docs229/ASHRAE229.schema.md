...
| `PRESSURE_BASED` | Pressure Based. The amount of air leakage is determined by induced airflows from pressure differences between zones, air distribution system components, the outside due to wind speed and direction and is then multiplied by the schedule.          |       |
| `SCHEDULED`      | Constant. The amount of air leakage is based on the infiltration_flow_rate multiplied by the schedule.                                                                                                                                                |       |
...
| `fans`                                                   | Terminal fan                                                                 | `{Fan}`                      |       |       |     | JG to verify if used in test case description.                                                                                                                                                                   |
...
| `interior_insulation` | Tank interior insulation R-value                                             | `Numeric`                      | K-m2/W | `≥0`  |     | From CBECC-Res.                                                                                                                 |
| `exterior_insulation` | Tank interior insulation R-value                                             | `Numeric`                      | K-m2/W | `≥0`  |     | From CBECC-Res.                                                                                                                 |
