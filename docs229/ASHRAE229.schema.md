...
| `infiltration_multiplier_schedule_name` | Infiltration multiplier schedule name                                                                                                                                                                                                                                                                                                                                                                                                                                                                   | `String`                                      |       |       |     |                                                    |
...
| `adjacent_to`               | Used to classify the conditions on the surface.                                           | `(<SurfaceAdjacentTo>,<AdditionalSurfaceAdjacentToRESNET>,<AdditionalSurfaceAdjacentTo2019ASHRAE901>)` |         |       |     | Determines whether this is an (a) exterior surface if adjacent to ambient, (b) slab-on-grad or below grade surface if adjacent to ground, or (c) interior surface if adjacent to another thermal block. |
| `adjacent_space_id`         | ID of the adjacent space for interior surface                                             | `String`                                                                                               |         |       |     |                                                                                                                                                                                                         |
| `is_adjacent_space_modeled` | True if the adjacent space is modeled.                                                    | `Boolean`                                                                                              |         |       |     | required for interior and other options that usually imply a modeled zone                                                                                                                               |
...
| `surface_optics`            | Optical properties of the surface.                                                        | `{SurfaceOptics}`                                                                                      |         |       |     |                                                                                                                                                                                                         |
...
| `glazed_u_factor`                       | Fenestration U-factor for the glazed portion                                               | `Numeric`                              | W/m2-K | `≥0`  |     | Includes interior and exterior air films as specified by the referenced standard. |
| `opaque_u_factor`                       | U-factor for the frame or opaque portions                                                  | `Numeric`                              | W/m2-K | `≥0`  |     | Includes interior and exterior air films as specified by the referenced standard. |
...
| `units_of_values`                     | The units associated witht the values of the schedule                              | `<ScheduleUnits>`                    |       |       |     | For certain schedule purposes, the values may be represented by units such as C for temperature or W for power.                                                                                                                                                       |
