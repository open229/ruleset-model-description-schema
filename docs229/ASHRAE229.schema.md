...
| `air_leakage_rate`         | Air leakage rate from infiltration of outside air         | `Numeric`                  | m3/s  | `≥0`  |     | Not needed if air_changes_per_hour is provided. |
| `air_changes_per_hour`     | Air changes per hour from infiltration of outside air.    | `Numeric`                  |       | `≥0`  |     | Not needed if air_leakage_rate is provided.     |
