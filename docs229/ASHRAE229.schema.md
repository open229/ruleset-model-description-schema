...
| `infiltration_schedule_name`       | Infiltration schedule name                                                                                                                                                                                                                                                                                                                                                                                                                                                                              | `String`                                      |       |       |     |                                                    |
...
# InternalGainEquipment
|                 Name                  |                                            Description                                             |      Data Type      | Units |  Range   | Req |                         Notes                          |
|---------------------------------------|----------------------------------------------------------------------------------------------------|---------------------|-------|----------|-----|--------------------------------------------------------|
| `energy_type`                         | Source of energy for the internal gain equipment                                                   | `<FuelTypeOptions>` |       |          |     |                                                        |
| `peak_usage`                          | Peak energy usage per hour by the internal gain equipment.                                         | `Numeric`           | W     |          |     |                                                        |
| `schedule_name`                       | Internal gain schedule name                                                                        | `String`            |       |          |     |                                                        |
...
| `power`                   | Total power for lights in the space.                                       | `Numeric`                              | W     |       |     |                                                |
